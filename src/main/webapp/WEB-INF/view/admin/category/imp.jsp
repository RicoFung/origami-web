...
<link rel="stylesheet" href="${ctx}/static/res/bs/plugin/fileinput/css/fileinput.min.css"/>
<script type="text/javascript" src="${ctx}/static/res/bs/plugin/fileinput/js/fileinput.min.js"></script>
<script type="text/javascript" src="${ctx}/static/res/chok/js/chok.view.add.js"></script>
